                                        ...
                                        <div class=""accordion"" id=""help"">
                                            ...
                                            <div class=""card"">
                                                ...
                                                <div id=""card-scene-change-area"" class=""collapse""
                                                    ...
                                                    <div class=""card-body"">
                                                        <p>
                                                            打者結果と同時に発生したプレー(補殺、失策、盗塁、盗塁死、WP、PB)、及びランナーの結果を入力します。<br />三振と同時の盗塁・盗塁死(三振ゲッツーなど)、振り逃げ(WP・PB)、四球の投球でのWP・PBによる進塁なども本エリアで入力します。ボーク・牽制死は「打席中ランナー結果」で入力します。<br />
                                                        ...
                                                        <ul class=""help-ul"">
                                                            <li>
                                                                対象選手<br>
                                                                発生したプレーに応じて対象選手を選択します(失策・補殺は野手、盗塁・盗塁死はランナー、WPは投手、PBは捕手)。<br>
