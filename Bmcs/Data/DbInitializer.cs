                    ...
                    else if ((int)value == (int)SystemAdminClass.TeamCreate)
                    {
                        messageDetail = @"<p>
                                            ...
                                            <p>
                                                ...
                                                非公開チームの場合、他チームへは公開されませんが、メールアドレスはチームパスワードの再設定に使用します。
                                            </p>
                                            <ul class=""help-ul"">
                                                <li>
                                                    代表者名<br>
                                                ...
                                                <li>
                                                    ...
                                                    サイト管理者からのご連絡、他チームからの連絡のほか、チームパスワードを忘れた際の再設定に使用します。<br>
                                                    登録がない場合、チームパスワードを忘れた際はお問い合わせによる対応となりますので、ご登録をおすすめします。<br>
                                                </li>
                                                <li>
                                                    メッセージ<br>
                                                    自由項目です。<br>
