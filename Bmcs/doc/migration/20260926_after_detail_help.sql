...
UPDATE dbo.SystemAdmin
   SET MessageDetail = REPLACE(MessageDetail, N'打者結果によって発生したプレー(補殺、失策)、及びランナーの結果を入力します。<br />', N'打者結果と同時に発生したプレー(補殺、失策、盗塁、盗塁死、WP、PB)、及びランナーの結果を入力します。<br />三振と同時の盗塁・盗塁死(三振ゲッツーなど)、振り逃げ(WP・PB)、四球の投球でのWP・PBによる進塁なども本エリアで入力します。ボーク・牽制死は「打席中ランナー結果」で入力します。<br />')
